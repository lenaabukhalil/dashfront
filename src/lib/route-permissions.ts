...
export const ROUTE_PERMISSIONS: Record<string, string | null> = {
  ...
  "/delete-wizard": "org.name",
  "/archive-diagnostic": "org.name",
  "/organizations": "org.name",
  "/locations": "org.name",
  "/chargers": "charger.status",
  "/connectors": "charger.status",
  "/tariffs": "tariff",
  "/users": "users.edit",
  "/users/charging-now": "users.edit",
  "/users/charged-today": "users.edit",
  "/app-users": "users.edit",
