...
export const RBAC_MATRIX: Record<Role, Record<PermissionKey, PermissionValue>> = {
  admin: {
    ...
    "tickets.manage": "RW",
    "audit.view": "-", "map.view": "-", "organizations.view": "-", "organizations.manage": "-",
    "reports.view": "-", "sessions.view": "-", "settings.view": "-", "stations.view": "-",
    "support.view": "-", "users.view": "-", "users.manage": "-", "rfid.view": "-",
    "locations.view": "-", "locations.manage": "-", "chargers.view": "-", "chargers.manage": "-",
    "tariffs.manage": "-", "bills.view": "-", "bills.export": "-", "global.access": "-",
  },
  manager: {
